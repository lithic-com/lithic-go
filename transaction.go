...
func (r TransactionResult) IsKnown() bool {
	switch r {
	case TransactionResultAccountPaused, TransactionResultAccountStateTransactionFail, TransactionResultApproved, TransactionResultBankConnectionError, TransactionResultBankNotVerified, TransactionResultCardClosed, TransactionResultCardPaused, TransactionResultDeclined, TransactionResultFraudAdvice, TransactionResultIgnoredTtlExpiry, TransactionResultSuspectedFraud, TransactionResultInactiveAccount, TransactionResultIncorrectPin, TransactionResultInvalidCardDetails, TransactionResultInsufficientFunds, TransactionResultInsufficientFundsPreload, TransactionResultInvalidTransaction, TransactionResultMerchantBlacklist, TransactionResultOriginalNotFound, TransactionResultPreviouslyCompleted, TransactionResultSingleUseRecharged, TransactionResultSwitchInoperativeAdvice, TransactionResultUnauthorizedMerchant, TransactionResultUnknownHostTimeout, TransactionResultUserTransactionLimit:
		return true
	}
	return false
}
...
const (
	...
	TransactionEventsDetailedResultScaRequired                                 TransactionEventsDetailedResult = "SCA_REQUIRED"
...
func (r TransactionEventsResult) IsKnown() bool {
	switch r {
	case TransactionEventsResultAccountPaused, TransactionEventsResultAccountStateTransactionFail, TransactionEventsResultApproved, TransactionEventsResultBankConnectionError, TransactionEventsResultBankNotVerified, TransactionEventsResultCardClosed, TransactionEventsResultCardPaused, TransactionEventsResultDeclined, TransactionEventsResultFraudAdvice, TransactionEventsResultIgnoredTtlExpiry, TransactionEventsResultSuspectedFraud, TransactionEventsResultInactiveAccount, TransactionEventsResultIncorrectPin, TransactionEventsResultInvalidCardDetails, TransactionEventsResultInsufficientFunds, TransactionEventsResultInsufficientFundsPreload, TransactionEventsResultInvalidTransaction, TransactionEventsResultMerchantBlacklist, TransactionEventsResultOriginalNotFound, TransactionEventsResultPreviouslyCompleted, TransactionEventsResultSingleUseRecharged, TransactionEventsResultSwitchInoperativeAdvice, TransactionEventsResultUnauthorizedMerchant, TransactionEventsResultUnknownHostTimeout, TransactionEventsResultUserTransactionLimit:
		return true
	}
	return false
}
...
const (
	...
	TransactionEventsRuleResultsResultScaRequired                                 TransactionEventsRuleResultsResult = "SCA_REQUIRED"
