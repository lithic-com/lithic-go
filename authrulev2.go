...
func init() {
	apijson.RegisterUnion(
		...
		apijson.UnionVariant{
			TypeFilter: gjson.JSON,
			Type:       reflect.TypeOf(ConditionalAuthorizationAdjustmentParameters{}),
		},
	)
}
...
func (r *ConditionalAuthorizationAdjustmentParameters) UnmarshalJSON(data []byte) (err error) {
	return apijson.UnmarshalRoot(data, r)
}

func (r conditionalAuthorizationAdjustmentParametersJSON) RawJSON() string {
	return r.raw
}

func (r ConditionalAuthorizationAdjustmentParameters) implementsAuthRuleCurrentVersionParameters() {}

func (r ConditionalAuthorizationAdjustmentParameters) implementsAuthRuleDraftVersionParameters() {}
...
type ConditionalAuthorizationAdjustmentParametersCondition struct {
	// The attribute to target.
	//
	// The following attributes may be targeted:
	//
	...
	//     cannot be geocoded. Requires `parameters.unit` set to `MILES` or `KILOMETERS`.
	//     Use a decimal value.
	Attribute ConditionalAuthorizationAdjustmentParametersConditionsAttribute `json:"attribute" api:"required"`
	// The operation to apply to the attribute
	Operation ConditionalOperation `json:"operation" api:"required"`
	// A regex string, to be used with `MATCHES` or `DOES_NOT_MATCH`
	Value ConditionalValueUnion `json:"value" api:"required"`
	...
	// `TRAVEL_SPEED` or `DISTANCE_FROM_LAST_TRANSACTION` (require `unit`). Not used
	// for other attributes.
	Parameters ConditionalAuthorizationAdjustmentParametersConditionsParameters `json:"parameters"`
	JSON       conditionalAuthorizationAdjustmentParametersConditionJSON        `json:"-"`
}

// conditionalAuthorizationAdjustmentParametersConditionJSON contains the JSON
// metadata for the struct [ConditionalAuthorizationAdjustmentParametersCondition]
type conditionalAuthorizationAdjustmentParametersConditionJSON struct {
	Attribute   apijson.Field
	Operation   apijson.Field
	Value       apijson.Field
	Parameters  apijson.Field
...
func (r *ConditionalAuthorizationAdjustmentParametersCondition) UnmarshalJSON(data []byte) (err error) {
	return apijson.UnmarshalRoot(data, r)
}

func (r conditionalAuthorizationAdjustmentParametersConditionJSON) RawJSON() string {
	return r.raw
}
...
//     cannot be geocoded. Requires `parameters.unit` set to `MILES` or `KILOMETERS`.
//     Use a decimal value.
type ConditionalAuthorizationAdjustmentParametersConditionsAttribute string

const (
	ConditionalAuthorizationAdjustmentParametersConditionsAttributeMcc                         ConditionalAuthorizationAdjustmentParametersConditionsAttribute = "MCC"
	ConditionalAuthorizationAdjustmentParametersConditionsAttributeCountry                     ConditionalAuthorizationAdjustmentParametersConditionsAttribute = "COUNTRY"
	ConditionalAuthorizationAdjustmentParametersConditionsAttributeCurrency                    ConditionalAuthorizationAdjustmentParametersConditionsAttribute = "CURRENCY"
	ConditionalAuthorizationAdjustmentParametersConditionsAttributeMerchantID                  ConditionalAuthorizationAdjustmentParametersConditionsAttribute = "MERCHANT_ID"
	ConditionalAuthorizationAdjustmentParametersConditionsAttributeDescriptor                  ConditionalAuthorizationAdjustmentParametersConditionsAttribute = "DESCRIPTOR"
	ConditionalAuthorizationAdjustmentParametersConditionsAttributeLiabilityShift              ConditionalAuthorizationAdjustmentParametersConditionsAttribute = "LIABILITY_SHIFT"
	ConditionalAuthorizationAdjustmentParametersConditionsAttributePanEntryMode                ConditionalAuthorizationAdjustmentParametersConditionsAttribute = "PAN_ENTRY_MODE"
	ConditionalAuthorizationAdjustmentParametersConditionsAttributeTransactionAmount           ConditionalAuthorizationAdjustmentParametersConditionsAttribute = "TRANSACTION_AMOUNT"
	ConditionalAuthorizationAdjustmentParametersConditionsAttributeCashAmount                  ConditionalAuthorizationAdjustmentParametersConditionsAttribute = "CASH_AMOUNT"
	ConditionalAuthorizationAdjustmentParametersConditionsAttributeRiskScore                   ConditionalAuthorizationAdjustmentParametersConditionsAttribute = "RISK_SCORE"
	ConditionalAuthorizationAdjustmentParametersConditionsAttributeCardTransactionCount15M     ConditionalAuthorizationAdjustmentParametersConditionsAttribute = "CARD_TRANSACTION_COUNT_15M"
	ConditionalAuthorizationAdjustmentParametersConditionsAttributeCardTransactionCount1H      ConditionalAuthorizationAdjustmentParametersConditionsAttribute = "CARD_TRANSACTION_COUNT_1H"
	ConditionalAuthorizationAdjustmentParametersConditionsAttributeCardTransactionCount24H     ConditionalAuthorizationAdjustmentParametersConditionsAttribute = "CARD_TRANSACTION_COUNT_24H"
	ConditionalAuthorizationAdjustmentParametersConditionsAttributeCardDeclineCount15M         ConditionalAuthorizationAdjustmentParametersConditionsAttribute = "CARD_DECLINE_COUNT_15M"
	ConditionalAuthorizationAdjustmentParametersConditionsAttributeCardDeclineCount1H          ConditionalAuthorizationAdjustmentParametersConditionsAttribute = "CARD_DECLINE_COUNT_1H"
	ConditionalAuthorizationAdjustmentParametersConditionsAttributeCardDeclineCount24H         ConditionalAuthorizationAdjustmentParametersConditionsAttribute = "CARD_DECLINE_COUNT_24H"
	ConditionalAuthorizationAdjustmentParametersConditionsAttributeCardState                   ConditionalAuthorizationAdjustmentParametersConditionsAttribute = "CARD_STATE"
	ConditionalAuthorizationAdjustmentParametersConditionsAttributePinEntered                  ConditionalAuthorizationAdjustmentParametersConditionsAttribute = "PIN_ENTERED"
	ConditionalAuthorizationAdjustmentParametersConditionsAttributePinStatus                   ConditionalAuthorizationAdjustmentParametersConditionsAttribute = "PIN_STATUS"
	ConditionalAuthorizationAdjustmentParametersConditionsAttributeWalletType                  ConditionalAuthorizationAdjustmentParametersConditionsAttribute = "WALLET_TYPE"
	ConditionalAuthorizationAdjustmentParametersConditionsAttributeTransactionInitiator        ConditionalAuthorizationAdjustmentParametersConditionsAttribute = "TRANSACTION_INITIATOR"
	ConditionalAuthorizationAdjustmentParametersConditionsAttributeAddressMatch                ConditionalAuthorizationAdjustmentParametersConditionsAttribute = "ADDRESS_MATCH"
	...
	ConditionalAuthorizationAdjustmentParametersConditionsAttributeStdevTransactionAmount      ConditionalAuthorizationAdjustmentParametersConditionsAttribute = "STDEV_TRANSACTION_AMOUNT"
	ConditionalAuthorizationAdjustmentParametersConditionsAttributeIsNewCountry                ConditionalAuthorizationAdjustmentParametersConditionsAttribute = "IS_NEW_COUNTRY"
	ConditionalAuthorizationAdjustmentParametersConditionsAttributeIsNewMcc                    ConditionalAuthorizationAdjustmentParametersConditionsAttribute = "IS_NEW_MCC"
	ConditionalAuthorizationAdjustmentParametersConditionsAttributeIsFirstTransaction          ConditionalAuthorizationAdjustmentParametersConditionsAttribute = "IS_FIRST_TRANSACTION"
	ConditionalAuthorizationAdjustmentParametersConditionsAttributeConsecutiveDeclines         ConditionalAuthorizationAdjustmentParametersConditionsAttribute = "CONSECUTIVE_DECLINES"
	ConditionalAuthorizationAdjustmentParametersConditionsAttributeTimeSinceLastTransaction    ConditionalAuthorizationAdjustmentParametersConditionsAttribute = "TIME_SINCE_LAST_TRANSACTION"
	ConditionalAuthorizationAdjustmentParametersConditionsAttributeDistinctCountryCount        ConditionalAuthorizationAdjustmentParametersConditionsAttribute = "DISTINCT_COUNTRY_COUNT"
	ConditionalAuthorizationAdjustmentParametersConditionsAttributeIsNewMerchant               ConditionalAuthorizationAdjustmentParametersConditionsAttribute = "IS_NEW_MERCHANT"
	ConditionalAuthorizationAdjustmentParametersConditionsAttributeThreeDSSuccessRate          ConditionalAuthorizationAdjustmentParametersConditionsAttribute = "THREE_DS_SUCCESS_RATE"
	ConditionalAuthorizationAdjustmentParametersConditionsAttributeTravelSpeed                 ConditionalAuthorizationAdjustmentParametersConditionsAttribute = "TRAVEL_SPEED"
	ConditionalAuthorizationAdjustmentParametersConditionsAttributeDistanceFromLastTransaction ConditionalAuthorizationAdjustmentParametersConditionsAttribute = "DISTANCE_FROM_LAST_TRANSACTION"
)
...
// `TRAVEL_SPEED` or `DISTANCE_FROM_LAST_TRANSACTION` (require `unit`). Not used
// for other attributes.
type ConditionalAuthorizationAdjustmentParametersConditionsParameters struct {
	// The time window for statistical attributes (`AMOUNT_Z_SCORE`,
	// `AVG_TRANSACTION_AMOUNT`, `STDEV_TRANSACTION_AMOUNT`). Use `LIFETIME` for
	// all-time history or a specific window (`7D`, `30D`, `90D`).
	Interval ConditionalAuthorizationAdjustmentParametersConditionsParametersInterval `json:"interval"`
	// The entity scope to evaluate the attribute against.
	Scope ConditionalAuthorizationAdjustmentParametersConditionsParametersScope `json:"scope"`
	// The unit for impossible travel attributes. Required when `attribute` is
	// `TRAVEL_SPEED` or `DISTANCE_FROM_LAST_TRANSACTION`.
	//
	// For `TRAVEL_SPEED`: `MPH` (miles per hour) or `KPH` (kilometers per hour).
	//
	// For `DISTANCE_FROM_LAST_TRANSACTION`: `MILES` or `KILOMETERS`.
	Unit ConditionalAuthorizationAdjustmentParametersConditionsParametersUnit `json:"unit"`
	JSON conditionalAuthorizationAdjustmentParametersConditionsParametersJSON `json:"-"`
}

// conditionalAuthorizationAdjustmentParametersConditionsParametersJSON contains
// the JSON metadata for the struct
// [ConditionalAuthorizationAdjustmentParametersConditionsParameters]
type conditionalAuthorizationAdjustmentParametersConditionsParametersJSON struct {
	Interval    apijson.Field
	Scope       apijson.Field
	Unit        apijson.Field
	raw         string
...
func (r *ConditionalAuthorizationAdjustmentParametersConditionsParameters) UnmarshalJSON(data []byte) (err error) {
	return apijson.UnmarshalRoot(data, r)
}

func (r conditionalAuthorizationAdjustmentParametersConditionsParametersJSON) RawJSON() string {
	return r.raw
}
...
// `AVG_TRANSACTION_AMOUNT`, `STDEV_TRANSACTION_AMOUNT`). Use `LIFETIME` for
// all-time history or a specific window (`7D`, `30D`, `90D`).
type ConditionalAuthorizationAdjustmentParametersConditionsParametersInterval string

const (
	ConditionalAuthorizationAdjustmentParametersConditionsParametersIntervalLifetime ConditionalAuthorizationAdjustmentParametersConditionsParametersInterval = "LIFETIME"
	ConditionalAuthorizationAdjustmentParametersConditionsParametersInterval7D       ConditionalAuthorizationAdjustmentParametersConditionsParametersInterval = "7D"
	ConditionalAuthorizationAdjustmentParametersConditionsParametersInterval30D      ConditionalAuthorizationAdjustmentParametersConditionsParametersInterval = "30D"
	ConditionalAuthorizationAdjustmentParametersConditionsParametersInterval90D      ConditionalAuthorizationAdjustmentParametersConditionsParametersInterval = "90D"
)

func (r ConditionalAuthorizationAdjustmentParametersConditionsParametersInterval) IsKnown() bool {
	switch r {
	case ConditionalAuthorizationAdjustmentParametersConditionsParametersIntervalLifetime, ConditionalAuthorizationAdjustmentParametersConditionsParametersInterval7D, ConditionalAuthorizationAdjustmentParametersConditionsParametersInterval30D, ConditionalAuthorizationAdjustmentParametersConditionsParametersInterval90D:
		return true
	}
	return false
}
...
// The entity scope to evaluate the attribute against.
type ConditionalAuthorizationAdjustmentParametersConditionsParametersScope string

const (
	ConditionalAuthorizationAdjustmentParametersConditionsParametersScopeCard            ConditionalAuthorizationAdjustmentParametersConditionsParametersScope = "CARD"
	ConditionalAuthorizationAdjustmentParametersConditionsParametersScopeAccount         ConditionalAuthorizationAdjustmentParametersConditionsParametersScope = "ACCOUNT"
	ConditionalAuthorizationAdjustmentParametersConditionsParametersScopeBusinessAccount ConditionalAuthorizationAdjustmentParametersConditionsParametersScope = "BUSINESS_ACCOUNT"
)

func (r ConditionalAuthorizationAdjustmentParametersConditionsParametersScope) IsKnown() bool {
	switch r {
	case ConditionalAuthorizationAdjustmentParametersConditionsParametersScopeCard, ConditionalAuthorizationAdjustmentParametersConditionsParametersScopeAccount, ConditionalAuthorizationAdjustmentParametersConditionsParametersScopeBusinessAccount:
		return true
	}
	return false
}
...
//
// For `DISTANCE_FROM_LAST_TRANSACTION`: `MILES` or `KILOMETERS`.
type ConditionalAuthorizationAdjustmentParametersConditionsParametersUnit string

const (
	ConditionalAuthorizationAdjustmentParametersConditionsParametersUnitMph        ConditionalAuthorizationAdjustmentParametersConditionsParametersUnit = "MPH"
	ConditionalAuthorizationAdjustmentParametersConditionsParametersUnitKph        ConditionalAuthorizationAdjustmentParametersConditionsParametersUnit = "KPH"
	ConditionalAuthorizationAdjustmentParametersConditionsParametersUnitMiles      ConditionalAuthorizationAdjustmentParametersConditionsParametersUnit = "MILES"
	ConditionalAuthorizationAdjustmentParametersConditionsParametersUnitKilometers ConditionalAuthorizationAdjustmentParametersConditionsParametersUnit = "KILOMETERS"
)

func (r ConditionalAuthorizationAdjustmentParametersConditionsParametersUnit) IsKnown() bool {
	switch r {
	case ConditionalAuthorizationAdjustmentParametersConditionsParametersUnitMph, ConditionalAuthorizationAdjustmentParametersConditionsParametersUnitKph, ConditionalAuthorizationAdjustmentParametersConditionsParametersUnitMiles, ConditionalAuthorizationAdjustmentParametersConditionsParametersUnitKilometers:
		return true
	}
	return false
}
...
const (
	...
	ConditionalCardTransactionUpdateActionParametersConditionsAttributeAmountZScore                ConditionalCardTransactionUpdateActionParametersConditionsAttribute = "AMOUNT_Z_SCORE"
	ConditionalCardTransactionUpdateActionParametersConditionsAttributeAvgTransactionAmount        ConditionalCardTransactionUpdateActionParametersConditionsAttribute = "AVG_TRANSACTION_AMOUNT"
	ConditionalCardTransactionUpdateActionParametersConditionsAttributeStdevTransactionAmount      ConditionalCardTransactionUpdateActionParametersConditionsAttribute = "STDEV_TRANSACTION_AMOUNT"
	ConditionalCardTransactionUpdateActionParametersConditionsAttributeIsNewCountry                ConditionalCardTransactionUpdateActionParametersConditionsAttribute = "IS_NEW_COUNTRY"
	ConditionalCardTransactionUpdateActionParametersConditionsAttributeIsNewMcc                    ConditionalCardTransactionUpdateActionParametersConditionsAttribute = "IS_NEW_MCC"
	ConditionalCardTransactionUpdateActionParametersConditionsAttributeIsFirstTransaction          ConditionalCardTransactionUpdateActionParametersConditionsAttribute = "IS_FIRST_TRANSACTION"
	ConditionalCardTransactionUpdateActionParametersConditionsAttributeConsecutiveDeclines         ConditionalCardTransactionUpdateActionParametersConditionsAttribute = "CONSECUTIVE_DECLINES"
	ConditionalCardTransactionUpdateActionParametersConditionsAttributeTimeSinceLastTransaction    ConditionalCardTransactionUpdateActionParametersConditionsAttribute = "TIME_SINCE_LAST_TRANSACTION"
	ConditionalCardTransactionUpdateActionParametersConditionsAttributeDistinctCountryCount        ConditionalCardTransactionUpdateActionParametersConditionsAttribute = "DISTINCT_COUNTRY_COUNT"
	ConditionalCardTransactionUpdateActionParametersConditionsAttributeIsNewMerchant               ConditionalCardTransactionUpdateActionParametersConditionsAttribute = "IS_NEW_MERCHANT"
	ConditionalCardTransactionUpdateActionParametersConditionsAttributeThreeDSSuccessRate          ConditionalCardTransactionUpdateActionParametersConditionsAttribute = "THREE_DS_SUCCESS_RATE"
	ConditionalCardTransactionUpdateActionParametersConditionsAttributeTravelSpeed                 ConditionalCardTransactionUpdateActionParametersConditionsAttribute = "TRAVEL_SPEED"
	ConditionalCardTransactionUpdateActionParametersConditionsAttributeDistanceFromLastTransaction ConditionalCardTransactionUpdateActionParametersConditionsAttribute = "DISTANCE_FROM_LAST_TRANSACTION"
)

func (r ConditionalCardTransactionUpdateActionParametersConditionsAttribute) IsKnown() bool {
	switch r {
	case ConditionalCardTransactionUpdateActionParametersConditionsAttributeMcc, ConditionalCardTransactionUpdateActionParametersConditionsAttributeCountry, ConditionalCardTransactionUpdateActionParametersConditionsAttributeCurrency, ConditionalCardTransactionUpdateActionParametersConditionsAttributeMerchantID, ConditionalCardTransactionUpdateActionParametersConditionsAttributeDescriptor, ConditionalCardTransactionUpdateActionParametersConditionsAttributeTransactionAmount, ConditionalCardTransactionUpdateActionParametersConditionsAttributeRiskScore, ConditionalCardTransactionUpdateActionParametersConditionsAttributeTransactionStatus, ConditionalCardTransactionUpdateActionParametersConditionsAttributeLastEventType, ConditionalCardTransactionUpdateActionParametersConditionsAttributeLiabilityShift, ConditionalCardTransactionUpdateActionParametersConditionsAttributePanEntryMode, ConditionalCardTransactionUpdateActionParametersConditionsAttributeWalletType, ConditionalCardTransactionUpdateActionParametersConditionsAttributeCardAge, ConditionalCardTransactionUpdateActionParametersConditionsAttributeAccountAge, ConditionalCardTransactionUpdateActionParametersConditionsAttributeSpendVelocityCount, ConditionalCardTransactionUpdateActionParametersConditionsAttributeSpendVelocityAmount, ConditionalCardTransactionUpdateActionParametersConditionsAttributeAmountZScore, ConditionalCardTransactionUpdateActionParametersConditionsAttributeAvgTransactionAmount, ConditionalCardTransactionUpdateActionParametersConditionsAttributeStdevTransactionAmount, ConditionalCardTransactionUpdateActionParametersConditionsAttributeIsNewCountry, ConditionalCardTransactionUpdateActionParametersConditionsAttributeIsNewMcc, ConditionalCardTransactionUpdateActionParametersConditionsAttributeIsFirstTransaction, ConditionalCardTransactionUpdateActionParametersConditionsAttributeConsecutiveDeclines, ConditionalCardTransactionUpdateActionParametersConditionsAttributeTimeSinceLastTransaction, ConditionalCardTransactionUpdateActionParametersConditionsAttributeDistinctCountryCount, ConditionalCardTransactionUpdateActionParametersConditionsAttributeIsNewMerchant, ConditionalCardTransactionUpdateActionParametersConditionsAttributeThreeDSSuccessRate, ConditionalCardTransactionUpdateActionParametersConditionsAttributeTravelSpeed, ConditionalCardTransactionUpdateActionParametersConditionsAttributeDistanceFromLastTransaction:
		return true
	}
	return false
}
...
type ConditionalCardTransactionUpdateActionParametersConditionsParameters struct {
	...
	// `AVG_TRANSACTION_AMOUNT`, `STDEV_TRANSACTION_AMOUNT`). Use `LIFETIME` for
	// all-time history or a specific window (`7D`, `30D`, `90D`).
	Interval ConditionalCardTransactionUpdateActionParametersConditionsParametersInterval `json:"interval"`
	...
	//
	// For `DISTANCE_FROM_LAST_TRANSACTION`: `MILES` or `KILOMETERS`.
	Unit ConditionalCardTransactionUpdateActionParametersConditionsParametersUnit `json:"unit"`
...
// `AVG_TRANSACTION_AMOUNT`, `STDEV_TRANSACTION_AMOUNT`). Use `LIFETIME` for
// all-time history or a specific window (`7D`, `30D`, `90D`).
type ConditionalCardTransactionUpdateActionParametersConditionsParametersInterval string

const (
	ConditionalCardTransactionUpdateActionParametersConditionsParametersIntervalLifetime ConditionalCardTransactionUpdateActionParametersConditionsParametersInterval = "LIFETIME"
	ConditionalCardTransactionUpdateActionParametersConditionsParametersInterval7D       ConditionalCardTransactionUpdateActionParametersConditionsParametersInterval = "7D"
	ConditionalCardTransactionUpdateActionParametersConditionsParametersInterval30D      ConditionalCardTransactionUpdateActionParametersConditionsParametersInterval = "30D"
	ConditionalCardTransactionUpdateActionParametersConditionsParametersInterval90D      ConditionalCardTransactionUpdateActionParametersConditionsParametersInterval = "90D"
)

func (r ConditionalCardTransactionUpdateActionParametersConditionsParametersInterval) IsKnown() bool {
	switch r {
	case ConditionalCardTransactionUpdateActionParametersConditionsParametersIntervalLifetime, ConditionalCardTransactionUpdateActionParametersConditionsParametersInterval7D, ConditionalCardTransactionUpdateActionParametersConditionsParametersInterval30D, ConditionalCardTransactionUpdateActionParametersConditionsParametersInterval90D:
		return true
	}
	return false
}
...
//
// For `DISTANCE_FROM_LAST_TRANSACTION`: `MILES` or `KILOMETERS`.
type ConditionalCardTransactionUpdateActionParametersConditionsParametersUnit string

const (
	ConditionalCardTransactionUpdateActionParametersConditionsParametersUnitMph        ConditionalCardTransactionUpdateActionParametersConditionsParametersUnit = "MPH"
	ConditionalCardTransactionUpdateActionParametersConditionsParametersUnitKph        ConditionalCardTransactionUpdateActionParametersConditionsParametersUnit = "KPH"
	ConditionalCardTransactionUpdateActionParametersConditionsParametersUnitMiles      ConditionalCardTransactionUpdateActionParametersConditionsParametersUnit = "MILES"
	ConditionalCardTransactionUpdateActionParametersConditionsParametersUnitKilometers ConditionalCardTransactionUpdateActionParametersConditionsParametersUnit = "KILOMETERS"
)

func (r ConditionalCardTransactionUpdateActionParametersConditionsParametersUnit) IsKnown() bool {
	switch r {
	case ConditionalCardTransactionUpdateActionParametersConditionsParametersUnitMph, ConditionalCardTransactionUpdateActionParametersConditionsParametersUnitKph, ConditionalCardTransactionUpdateActionParametersConditionsParametersUnitMiles, ConditionalCardTransactionUpdateActionParametersConditionsParametersUnitKilometers:
		return true
	}
	return false
}
...
type ReportStats struct {
	...
	Examples []ReportStatsExample `json:"examples" api:"required"`
	// The evaluation mode of this version during the reported period.
	State ReportStatsState `json:"state" api:"required"`
...
type ReportStatsExample struct {
	...
	Actions []ReportStatsExamplesAction `json:"actions" api:"required"`
	// The event token.
...
const (
	...
	ReportStatsExamplesActionsDeclineActionAuthorizationCodeScaRequired                                 ReportStatsExamplesActionsDeclineActionAuthorizationCode = "SCA_REQUIRED"
...
const (
	...
	ReportStatsExamplesActionsCodeScaRequired                                 ReportStatsExamplesActionsCode = "SCA_REQUIRED"
...
// The evaluation mode of this version during the reported period.
type ReportStatsState string

const (
	ReportStatsStateActive   ReportStatsState = "ACTIVE"
	ReportStatsStateShadow   ReportStatsState = "SHADOW"
	ReportStatsStateInactive ReportStatsState = "INACTIVE"
)

func (r ReportStatsState) IsKnown() bool {
	switch r {
	case ReportStatsStateActive, ReportStatsStateShadow, ReportStatsStateInactive:
		return true
	}
	return false
}
...
const (
	...
	AuthRuleV2ListResultsResponseAuthorizationResultActionsDeclineActionAuthorizationCodeScaRequired                                 AuthRuleV2ListResultsResponseAuthorizationResultActionsDeclineActionAuthorizationCode = "SCA_REQUIRED"
...
const (
	...
	AuthRuleV2ListResultsResponseAuthorizationResultActionsCodeScaRequired                                 AuthRuleV2ListResultsResponseAuthorizationResultActionsCode = "SCA_REQUIRED"
...
type AuthRuleV2GetReportResponseDailyStatistic struct {
	...
	// day.
	Versions []ReportStats                                 `json:"versions" api:"required"`
