...
func TestThreeDSDecisioningSimulateChallengeWithOptionalParams(t *testing.T) {
	baseURL := "http://localhost:4010"
	if envURL, ok := os.LookupEnv("TEST_API_BASE_URL"); ok {
		baseURL = envURL
	}
	...
	_, err := client.ThreeDS.Decisioning.SimulateChallenge(context.TODO(), lithic.ThreeDSDecisioningSimulateChallengeParams{
...
func TestThreeDSDecisioningSimulateChallengeResponse(t *testing.T) {
	baseURL := "http://localhost:4010"
	if envURL, ok := os.LookupEnv("TEST_API_BASE_URL"); ok {
		baseURL = envURL
	}
	...
	err := client.ThreeDS.Decisioning.SimulateChallengeResponse(context.TODO(), lithic.ThreeDSDecisioningSimulateChallengeResponseParams{
		ChallengeResponse: lithic.ChallengeResponseParam{
			Token:             lithic.F("182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e"),
			ChallengeResponse: lithic.F(lithic.ChallengeResultApprove),
		},
