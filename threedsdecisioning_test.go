...
func TestThreeDSDecisioningChallengeResponse(t *testing.T) {
	...
	err := client.ThreeDS.Decisioning.ChallengeResponse(context.TODO(), lithic.ThreeDSDecisioningChallengeResponseParams{
		...
		ChallengeResponse: lithic.F(lithic.ThreeDSDecisioningChallengeResponseParamsChallengeResponseApprove),
	})
	if err != nil {
