...
func TestDisputesV2Get(t *testing.T) {
	...
	_, err := client.DisputesV2.Get(context.TODO(), "182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e")
	if err != nil {
...
func TestDisputesV2ListWithOptionalParams(t *testing.T) {
	baseURL := "http://localhost:4010"
	if envURL, ok := os.LookupEnv("TEST_API_BASE_URL"); ok {
		baseURL = envURL
	}
	...
	_, err := client.DisputesV2.List(context.TODO(), lithic.DisputesV2ListParams{
