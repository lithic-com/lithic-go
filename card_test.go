...
func TestCardNewWithOptionalParams(t *testing.T) {
	...
	_, err := client.Cards.New(context.TODO(), lithic.CardNewParams{
		...
		DigitalCardArtToken:     lithic.F("5e9483eb-8103-4e16-9794-2106111b2eca"),
		ExpMonth:                lithic.F("06"),
		ExpYear:                 lithic.F("2027"),
		Memo:                    lithic.F("New Card"),
		Pin:                     lithic.F("pin"),
		ProductID:               lithic.F("1"),
		ReplacementAccountToken: lithic.F("5e9483eb-8103-4e16-9794-2106111b2eca"),
		ReplacementComment:      lithic.F("replacement_comment"),
		ReplacementFor:          lithic.F("5e9483eb-8103-4e16-9794-2106111b2eca"),
...
func TestCardUpdateWithOptionalParams(t *testing.T) {
	...
	_, err := client.Cards.Update(
		...
		lithic.CardUpdateParams{
			...
			NetworkProgramToken: lithic.F("00000000-0000-0000-1000-000000000000"),
			Pin:                 lithic.F("pin"),
...
func TestCardReassignAccount(t *testing.T) {
	baseURL := "http://localhost:4010"
	if envURL, ok := os.LookupEnv("TEST_API_BASE_URL"); ok {
		baseURL = envURL
	}
	...
	_, err := client.Cards.ReassignAccount(
		context.TODO(),
		"182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e",
...
func TestCardGetSignals(t *testing.T) {
	baseURL := "http://localhost:4010"
	if envURL, ok := os.LookupEnv("TEST_API_BASE_URL"); ok {
		baseURL = envURL
	}
	...
	_, err := client.Cards.GetSignals(context.TODO(), "182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e")
	if err != nil {
		var apierr *lithic.Error
		if errors.As(err, &apierr) {
			t.Log(string(apierr.DumpRequest(true)))
