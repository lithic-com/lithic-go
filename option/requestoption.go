...
// RequestOption is an option for the requests made by the lithic API Client
// which can be supplied to clients, services, and methods. You can read more about this functional
// options pattern in our [README].
//
// [README]: https://pkg.go.dev/github.com/lithic-com/lithic-go#readme-requestoptions
...
func WithEnvironmentProduction() RequestOption {
	return requestconfig.WithDefaultBaseURL("https://api.lithic.com/")
}
...
func WithEnvironmentSandbox() RequestOption {
	return requestconfig.WithDefaultBaseURL("https://sandbox.lithic.com/")
}
