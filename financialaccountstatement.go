...
const (
	...
	StatementAccountStandingFinancialAccountStateSubstatusInterestAndFeesPaused StatementAccountStandingFinancialAccountStateSubstatus = "INTEREST_AND_FEES_PAUSED"
)

func (r StatementAccountStandingFinancialAccountStateSubstatus) IsKnown() bool {
	switch r {
	case StatementAccountStandingFinancialAccountStateSubstatusChargedOffDelinquent, StatementAccountStandingFinancialAccountStateSubstatusChargedOffFraud, StatementAccountStandingFinancialAccountStateSubstatusEndUserRequest, StatementAccountStandingFinancialAccountStateSubstatusBankRequest, StatementAccountStandingFinancialAccountStateSubstatusDelinquent, StatementAccountStandingFinancialAccountStateSubstatusInterestAndFeesPaused:
		return true
	}
	return false
}
