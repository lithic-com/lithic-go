...
const (
	...
	LoanTapeAccountStandingFinancialAccountStateSubstatusInterestAndFeesPaused LoanTapeAccountStandingFinancialAccountStateSubstatus = "INTEREST_AND_FEES_PAUSED"
)

func (r LoanTapeAccountStandingFinancialAccountStateSubstatus) IsKnown() bool {
	switch r {
	case LoanTapeAccountStandingFinancialAccountStateSubstatusChargedOffDelinquent, LoanTapeAccountStandingFinancialAccountStateSubstatusChargedOffFraud, LoanTapeAccountStandingFinancialAccountStateSubstatusEndUserRequest, LoanTapeAccountStandingFinancialAccountStateSubstatusBankRequest, LoanTapeAccountStandingFinancialAccountStateSubstatusDelinquent, LoanTapeAccountStandingFinancialAccountStateSubstatusInterestAndFeesPaused:
		return true
	}
	return false
}
